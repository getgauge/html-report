...
type ProtoSpec struct {
	...
	PreHookMessage []string `protobuf:"bytes,8,rep,name=preHookMessage" json:"preHookMessage,omitempty"`
	// / Additional information at post hook exec time to be available on reports
	PostHookMessage []string `protobuf:"bytes,9,rep,name=postHookMessage" json:"postHookMessage,omitempty"`
}
...
type ProtoSuiteResult struct {
	...
	// / Additional information at pre hook exec time to be available on reports
	PreHookMessage []string `protobuf:"bytes,13,rep,name=preHookMessage" json:"preHookMessage,omitempty"`
	// / Additional information at post hook exec time to be available on reports
	PostHookMessage []string `protobuf:"bytes,14,rep,name=postHookMessage" json:"postHookMessage,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
