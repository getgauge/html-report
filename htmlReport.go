...
func createReport(suiteResult *gauge_messages.SuiteExecutionResult) {
	...
	createHtmlReport(jsContents, shouldOverwriteReports())
}

func createHtmlReport(jsContents []byte, shouldOverwrite bool) {
	reportsDir := createReportsDirectory()
	...
	err := writeResultJsFile(currentReportDir, jsContents)
	if err != nil {
