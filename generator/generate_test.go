...
var wResCntDiv = `
  <div class="report_test-results">
		<div class="report_test-result">
				<div class="total-specs"><span class="value">41</span><span class="txt">Total specs</span></div>
				<div class="fail spec-filter" data-status="failed"><span class="value">2</span><span class="txt">Failed</span></div>
				<div class="pass spec-filter" data-status="passed"><span class="value">39</span><span class="txt">Passed</span></div>
				<div class="skip spec-filter" data-status="skipped"><span class="value">0</span><span class="txt">Skipped</span></div>
		</div>
		<div class="report_test-result">
				<div class="total-specs"><span class="value">41</span><span class="txt">Total scenario</span></div>
				<div class="fail scenario-filter" data-status="failed"><span class="value">2</span><span class="txt">Failed</span></div>
				<div class="pass scenario-filter" data-status="passed"><span class="value">39</span><span class="txt">Passed</span></div>
				<div class="skip scenario-filter" data-status="skipped"><span class="value">0</span><span class="txt">Skipped</span></div>
		</div>
  </div>`
