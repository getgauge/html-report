...
var wSidebarAside = `<aside class="sidebar">
  ...
  <div class='specs-sorting'>
     <span class="fas fa-sort sort sort-specs-name" data-sort-by="specs-name">Name</span>
     <span class="fas fa-sort sort sort-execution-time" data-sort-by="execution-time">Execution time</span>
  </div>
